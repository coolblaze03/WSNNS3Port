...
_wrap_PyNs3DsdvRoutingTable_AddIpv4Event(PyNs3DsdvRoutingTable *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!O!", (char **) keywords, &PyNs3Ipv4Address_Type, &arg0, &PyNs3EventId_Type, &arg1)) {
        return NULL;
    }
    retval = self->obj->AddIpv4Event(*((PyNs3Ipv4Address *) arg0)->obj, *((PyNs3EventId *) arg1)->obj);
    py_retval = Py_BuildValue((char *) "N", PyBool_FromLong(retval));
    return py_retval;
}
