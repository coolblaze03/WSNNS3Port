...
class message{
        public:
	        message(){
		        ...
		        this->type = HELLO;
		        this->data = "";
		        MiscAddress = Ipv4Address("000.000.000.001");
		        update=false;
		        x = -1;
		        y = -1;
		        skip = false;
            ...
            message(uint8_t * packetdata){
            	...
            	test[0] = test[0];
					...
					this->MiscAddress =  Ipv4Address(out.substr(counter,15).c_str());
					counter += 15;
	        ...
	        message& operator=(const message &rhs){
		        ...
		        //        out += ZeroPadNumber(val,3);
	                //}
                        ...
                        //if (MiscAddress != Ipv4Address("000.000.000.000")){
                        	out += formatAddy(MiscAddress.Get());
                        //}else{
