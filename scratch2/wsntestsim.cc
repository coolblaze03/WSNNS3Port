...
//Sensors
  ...
  basicSourceHelper.Set ("BasicEnergySourceInitialEnergyJ", DoubleValue (100)); //energy source intial joules
  ...
  olsr.Set("TcInterval",TimeValue (Seconds (10)));
  olsr.Set("MidInterval",TimeValue (Seconds (10)));
  olsr.Set("HnaInterval",TimeValue (Seconds (10)));
